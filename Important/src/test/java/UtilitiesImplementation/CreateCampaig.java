...
FileInputStream fis=new FileInputStream("D:\\Users\\kirit\\eclipse-workspace\\Important\\src\\test\\resources\\commondata.properties");
		...
		String PASSWORD = prop.getProperty("Password"); 
		 ...
		 //Read data from excel 
		  FileInputStream fis1=new FileInputStream("D:\\Users\\kirit\\eclipse-workspace\\Important\\testdata_excel\\createExcel.xlsx"); 
		  Workbook wb = WorkbookFactory.create(fis1); 
		  Sheet sh = wb.getSheet("Campaign"); 
		  String campname =sh.getRow(1).getCell(3).getStringCellValue(); 
		  String size =  sh.getRow(2).getCell(3).toString(); 
